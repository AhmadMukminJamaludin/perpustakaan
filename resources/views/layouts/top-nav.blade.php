...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="{{ url('/') }}" class="navbar-brand">
                    <span class="brand-text font-weight-light">SMA NEGERI 1 GUBUG</span>
                </a>
        ...
        <footer class="main-footer">
            <strong>&copy; {{ date('Y') }} {{ config('app.name', 'Perpustakaan Online') }}.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
                ...
                axios.get('{{ route('cart.view') }}') // Pastikan route ini sesuai dengan controller
                    .then(response => {
                      ...
                      `;
                            ...
                            buttons: {
                                checkout: {
                                    ...
                                    action: function() {
                                        ...
                                        var tanggalPinjam = new Date().toISOString().split(
                                            'T')[0];
                        ...
                        $(document).off('click', '.remove-from-cart').on('click', '.remove-from-cart',
                            function() {
